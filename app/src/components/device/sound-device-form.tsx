    ...
    if (open) {
      if (device) {
        ...
        reset({
          ...
          powerType: '', protocols: [], mountType: [], powerConnectorsIn: [],
        });
      }
      ...
      <DialogContent className="sm:max-w-3xl">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-4 py-4 max-h-[80vh] overflow-y-auto pr-4">
            ...
            <FormField control={control} name="notes" render={({ field }) => (<FormItem><FormLabel>{t('common.notes')}</FormLabel><FormControl><Textarea placeholder={t('devices.notes_placeholder')} {...field} /></FormControl><FormMessage /></FormItem>)} />
